...
const ScienceNews = () => {
  ...
  useEffect(() => {
    axiosInstance.get("/all-science-news").then((res) => {
      const data = res.data;
      setScienceNews(data);
    });
  }, []);
      ...
      <div className="">
        <div className="h-auto w-full ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {scienceNews.map((sci) => (
              <div
              onClick={() => navigate(`/category/${sci?._id}`)}
            ...
            >
              <figure>
                <img
                  ...
                  src={sci?.image || sci?.imageUrl}
                  alt="Business"
                />
              </figure>
              <div className="px-2 pt-2 pb-5">
                <h2 className="text-xl  font-bold">{sci?.headLine}</h2>
                <div
                  dangerouslySetInnerHTML={{ __html: sci?.details }}
